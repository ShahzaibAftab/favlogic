...
// Full-screen Light Theme Dashboard Skeleton matching exact screenshot layout, made responsive
  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <div style={{ display: 'flex', alignItems: 'center', marginRight: '8px' }}>
            ...
            <span style={{ fontWeight: 800, fontSize: '16px', color: '#0284c7' }}>BOXpad</span>
          </div>
          ...
          <div className="hidden lg:flex" style={{ gap: '4px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '12.5px', fontWeight: 500, color: '#111827' }} className="hidden sm:inline">Michael Johnson</span>
          </div>
        </div>
      </header>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', background: '#d9dad5', padding: '8px', gap: '8px' }}>
        ...
        {/* 1. Left Sidebar Skeleton (Desktop only) */}
        <aside style={{
          width: '180px',
          flexShrink: 0,
          borderRadius: '12px',
        ...
        {/* 3. Active Chat Window Skeleton */}
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: '#ffffff', minWidth: 0, borderRadius: '12px', border: '1px solid #e2e8f0', overflow: 'hidden' }} className="hidden md:flex">
          <div style={{
            height: '52px',
            borderBottom: '1px solid #e5e7eb',
            display: 'flex',
        ...
        {/* 4. Details Panel Skeleton (Desktop only) */}
        <aside style={{
          width: '272px',
          flexShrink: 0,
          borderRadius: '12px',
